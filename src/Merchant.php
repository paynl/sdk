...
class Merchant {
	 ...
	 */
	static function addTradeName($tradeName){
	 ...
	 * @return bool
	 */
	static function deleteTradeName($tradeNameId){
	 ...
	 */
	static function info($merchantId = null){
		$api = new Api\Info();

		if($merchantId !== null) $api->setMerchantId($merchantId);
	 ...
	 * @return array
	 */
	static function getTradeNames($merchantId = null){
