...
class CaptureTest extends UnitTest
{
    ...
    public function testItCanSetATransactionId(): void
    {
        ...
        verify($this->request->setTransactionId('1234'))->isInstanceOf(Capture::class);
    }
    ...
    public function testItCanGetUri(): void
    {
        ...
        verify($this->request->getUri())->equals('transactions/1234/capture');
    }
