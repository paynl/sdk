 ...
 */
class TokenizeTest extends UnitTest
{
    /**
     * @var Tokenize
     */
    ...
    {
        $this->request = new Tokenize('1234', '1234567890');
    }
    ...
    public function testItCanSetATransactionId(): void
    {
        ...
        verify($this->request->setTransactionId('1234'))->isInstanceOf(Tokenize::class);
    }
