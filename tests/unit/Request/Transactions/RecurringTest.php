 ...
 */
class RecurringTest extends UnitTest
{
    /**
     * @var Recurring
     */
    ...
    {
        /** @var RecurringTransaction $recurringTransactionMock */
        $recurringTransactionMock = $this->createMock(RecurringTransaction::class);
        $this->request = new Recurring('1234', $recurringTransactionMock);
    }
    ...
    public function testItCanSetATransactionId(): void
    {
        ...
        verify($this->request->setTransactionId('1234'))->isInstanceOf(Recurring::class);
    }
    ...
    public function testItCanGetUri(): void
    {
        ...
        verify($this->request->getUri())->equals('transactions/1234/recurring');
    }
